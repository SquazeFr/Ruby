...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference("Bet.count") do
      post bets_url, params: { bet: { Desc: @bet.Desc, LogoA: @bet.LogoA, LogoB: @bet.LogoB, TeamA: @bet.TeamA, TeamB: @bet.TeamB, date: @bet.date, prediA: @bet.prediA, prediB: @bet.prediB } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { Desc: @bet.Desc, LogoA: @bet.LogoA, LogoB: @bet.LogoB, TeamA: @bet.TeamA, TeamB: @bet.TeamB, date: @bet.date, prediA: @bet.prediA, prediB: @bet.prediB } }
